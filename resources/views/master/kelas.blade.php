...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        ...
        <div class="ibox-content">
            <table id="kelas-table" class="table table-striped table-bordered table-hover" >
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Kode Kelas</th>
        ...
        <form method="post" class="form-horizontal" data-toggle="validator">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="name" class="col-md-3 control-label">Kode Kelas</label>
                    <div class="col-md-6">
                        <input type="text" id="kode_kelas" name="kode_kelas" class="form-control" autofocus required>
                        <span class="help-block with-errors"></span>
                    </div>
                </div>
                <div class="form-group">
                    <label for="name" class="col-md-3 control-label">Nama Kelas</label>
                    <div class="col-md-6">
                        <input type="text" id="nama_kelas" name="nama_kelas" class="form-control" autofocus required>
                        <span class="help-block with-errors"></span>
                    </div>
                </div>
                <div class="form-group">
...
<script>
    ...
    function addForm(){
        ...
        $('.modal-title').text('Tambah Master Kelas');
    }
