        ...
        <form method="post" class="form-horizontal" data-toggle="validator">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="name" class="col-md-3 control-label">Kode Mata Pelajaran</label>
                    <div class="col-md-6">
                        <input type="text" id="kode_mapel" name="kode_mapel" class="form-control" autofocus required>
                        <span class="help-block with-errors"></span>
                    </div>
                </div>
                <div class="form-group">
                    <label for="name" class="col-md-3 control-label">Nama Mata Pelajaran</label>
                    <div class="col-md-6">
                        <input type="text" id="nama_mapel" name="nama_mapel" class="form-control" autofocus required>
                        <span class="help-block with-errors"></span>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function addForm(){
        ...
        $('.modal-title').text('Tambah Master Mata Pelajaran');
    }
